      ...
      >
        ...
        >
          ...
          <div className="empty-state-title">
            ...
            <h1>Topic Guardrails Demo</h1>
            <p className="empty-state-description">
              This agent only talks about Botpress. Try going off-topic to see guardrails in action.
            </p>
          </div>
          {/* Suggestion buttons */}
          ...
          <Composer
            ...
            connected={clientState !== "disconnected"}
            sendMessage={sendMessage}
            composerPlaceholder="Ask about Botpress..."
          />
        </Container>
        <div className="composer-footer-text">
          ...
          <span>
            ...
            <a
              href="https://github.com/botpress/adk/tree/main/examples/guardrails"
              target="_blank"
