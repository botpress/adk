...
/**
 * Parse a role ref string (e1, @e1, ref=e1) into the normalized ref (e1).
 */
...
/**
 * Build a role snapshot from Playwright's aria snapshot output.
 * Assigns refs (e1, e2, etc.) to interactive and important content elements.
 */
