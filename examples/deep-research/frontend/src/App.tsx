...
import { ResearchDataProvider } from "./context/ResearchDataContext";
...
function AppContent() {
  ...
  // Set up polling for in-progress research messages
  useResearchPolling({
    messages,
    conversationId,
    clientId: CLIENT_ID,
  ...
  const { researchData, isOpen, isModalOpen, closeResearch, closeModal } =
    useResearchContext();
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="suggestion-buttons">
            {[
              "Compare the latest AI coding assistants",
      ...
      {/* Side Panel for in-progress research */}
      {researchData && (
        <ResearchPanel
          data={researchData}
          isOpen={isOpen}
