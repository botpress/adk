  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        side === "right" &&
          "inset-y-0 right-0 h-full w-3/4 max-w-md border-l border-gray-200 dark:border-gray-700 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-lg",
        side === "left" &&
        ...
        side === "top" &&
          "inset-x-0 top-0 border-b border-gray-200 dark:border-gray-700 data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
        side === "bottom" &&
